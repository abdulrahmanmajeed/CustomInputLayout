    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            case R.id.checkbox_hint:
                ...
                if (isChecked)
                    tv_inout_lay.setHint("Set prompt text");
                break;
            ...
            case R.id.checkbox_error:
                ...
                if (isChecked)
                    tv_inout_lay.setError("Error message");
                break;
            ...
            case R.id.checkbox_hint_style:
                if (isChecked) {
                    ...
                    tv_inout_lay.setHint("The boss said that the colors should be bright and the characters should be big!");
                } else {
            ...
            case R.id.checkbox_over_style:
                if (isChecked) {            //自定义图标样式
                    tv_inout_lay.setPasswordVisibilityToggleDrawable(R.drawable.design_password_eye_icon);
                } else {
                    tv_inout_lay.setPasswordVisibilityToggleDrawable(R.drawable.design_password_eye_icon);
                }
